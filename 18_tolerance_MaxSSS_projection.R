#getting tolerance levels from maxSSS projection thresholds

library(raster)

#repeat code for each projection
#get data
...
setwd("C:/Users/Kat/Desktop/ENM_Fourth_Try/kuenm/projection/Set_7/Set_7_tfgSc")
...
write.csv(results, "tfgSc_consensus_tolerance_maxSSS.csv", row.names=T)
