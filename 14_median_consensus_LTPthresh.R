...
raster_files<-list.files("C:/Users/Kat/Desktop/ENM_Fourth_Try/kuenm/112_median_E_LTP_thresh", 
                         full.names = T)
...
raster::writeRaster(mean, "median_consensus_LTPthresh", format='ascii')
...
raster_files<-list.files("C:/Users/Kat/Desktop/ENM_Fourth_Try/kuenm/tfgSe_median_E_LTP_thresh", 
