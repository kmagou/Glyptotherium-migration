...
#get maxent data
setwd("C:/Users/Kat/Desktop/ENM_Fourth_Try/kuenm/final_combo_tfgSd_median_E_5")
...
ggsave("med_med_tfgsd.eps", width = 17, height = 10, units = "cm")
...
#save
setwd("C:/Users/Kat/Desktop/plots")
ggsave("med_med_tfgsd_zoom.eps", width = 15, height = 7, units = "cm")
